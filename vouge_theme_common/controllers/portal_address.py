...
class PortalUser(http.Controller):
    ...
    def action_update_image(self,**post):
        ...
        return request.env['ir.ui.view']._render_template("theme_vouge.update_user_image",values)
...
class PortalAddress(http.Controller):
	...
	def partner_address(self,**post):
		...
		return request.render('theme_vouge.address_list',values)
	...
	def add_new_address(self,**post):
		...
		return request.render('theme_vouge.add_address',values)